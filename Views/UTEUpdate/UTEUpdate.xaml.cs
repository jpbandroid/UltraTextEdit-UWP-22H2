...
namespace UltraTextEdit_UWP.Views.UTEUpdate
{
    ...
    public sealed partial class UTEUpdate : Page
    {
        ...
        private async void CheckUpdate(object sender, RoutedEventArgs e)
        {
            ...
            Stream stream = client.OpenRead("https://github.com/jpbandroid/UpdateZips/raw/main/UTE-22H2-version.txt");
        ...
        private async void CommandInvokedHandler(IUICommand command)
        {
            if (command.Label == "Update")
            {
                ...
                await packagemanager.AddPackageAsync(
                    new Uri("https://github.com/jpbandroid/UpdateZips/raw/main/UTE-22H2-latest.msixbundle"),
                    null,
